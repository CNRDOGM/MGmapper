...
wget -nH --cut-dirs=3 -P $downloadLOG ftp://ftp.ncbi.nlm.nih.gov/genomes/genbank/protozoa/assembly_summary.txt -o $downloadLOG/assembly_summary.log
...
cut -f 2 $downloadLOG/taxid_filename.txt | ${perl_scripts}/joinSequences.pl -d plasmid  -v -o ${metagenomicsDB}/${organism}.fsa -l ${metagenomicsLOG}/joinSequences.log
