...
# Bacteria_draft
${sh_scripts}/bwa.sh $organismDraft ${metagenomicsDBDraft}  >& /dev/null
${sh_scripts}/samtools.sh $organismDraft ${metagenomicsDBDraft}  >& /dev/null
#${sh_scripts}/makeblastdb.sh ${metagenomicsDBDraft}/$organismDraft ${metagenomicsDBDraft} $organismDraft >& /dev/null

# plasmid
${sh_scripts}/bwa.sh $organismPlasmid ${metagenomicsDBPlasmid}  >& /dev/null
${sh_scripts}/samtools.sh $organismPlasmid ${metagenomicsDBPlasmid}  >& /dev/null
${sh_scripts}/makeblastdb.sh ${metagenomicsDBPlasmid}/$organismPlasmid ${metagenomicsDBPlasmid} $organismPlasmid >& /dev/null
