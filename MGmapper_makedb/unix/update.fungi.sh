...
wget -nH --cut-dirs=3 -P $downloadLOG ftp://ftp.ncbi.nlm.nih.gov/genomes/genbank/fungi/assembly_summary.txt -o $downloadLOG/assembly_summary.log
...
sh ${sh_scripts}/bwa.sh $organism  $metagenomicsDB >& /dev/null
sh ${sh_scripts}/samtools.sh $organism $metagenomicsDB >& /dev/null
